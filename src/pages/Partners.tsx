  ...
  const partnerCategories = [
    {
      ...
      partners: [
        ...
        },
        {
          ...
          description: '12% off on combo meals',
        ...
        {
          name: 'Spice Route',
          description: '18% off on Indian cuisine',
        ...
        {
          name: 'South Tiffin',
          description: '25% off on breakfast',
        ...
        {
          name: 'Chai & More',
          description: '15% off on beverages',
          phone: '+91 98765 43216',
          email: 'hello@chaiandmore.com',
          logo: 'https://images.unsplash.com/photo-1571934811356-5cc061b6821f?w=100&h=100&fit=crop&crop=center',
        },
        {
          name: 'Healthy Bites',
        ...
        },
        {
          ...
          description: '10% off on fresh juices',
    ...
    },
    {
      ...
      partners: [
        {
          name: 'PowerFit Gym',
          description: '25% off on memberships',
        ...
        {
          name: 'Flex Fitness',
          description: '30% off on personal training',
          phone: '+91 98765 43222',
          email: 'train@flexfitness.com',
          logo: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=100&h=100&fit=crop&crop=center',
        },
        {
          name: 'VR World',
          description: '15% off on VR experiences',
    ...
    },
    {
      ...
      partners: [
        {
          name: 'Style Studio',
          description: '20% off on haircuts',
          phone: '+91 98765 43224',
          email: 'book@stylestudio.com',
          logo: 'https://images.unsplash.com/photo-1562004760-acb5292b5cef?w=100&h=100&fit=crop&crop=center',
        },
        {
          name: 'Gents Parlor',
          description: '15% off on grooming',
          phone: '+91 98765 43225',
          email: 'groom@gentsparlor.com',
          logo: 'https://images.unsplash.com/photo-1599351431556-3ce0643c69de?w=100&h=100&fit=crop&crop=center',
        },
        {
          name: 'Unisex Salon',
        ...
        {
          name: 'Quick Cuts',
          description: '10% off on express cuts',
        ...
        },
        {
          ...
          description: '30% off on premium packages',
    ...
    },
    {
      ...
      partners: [
        {
          name: 'Sweet Treats',
          description: '15% off on ice creams',
        ...
        {
          name: 'Cake Corner',
          description: '20% off on custom cakes',
        ...
        {
          name: 'Donut Delight',
          description: '12% off on dozen packs',
        ...
        {
          name: 'Frozen Yogurt',
          description: '18% off on all flavors',
          phone: '+91 98765 43232',
          email: 'cool@frozenyogurt.com',
          logo: 'https://images.unsplash.com/photo-1547826039-bfc35e0f1ea8?w=100&h=100&fit=crop&crop=center',
        },
      ]
    }
  ];
